(function () {
  ...
  ready(function () {
    ...
    const followModelInput = document.getElementById("follow-text-model");
    ...
    if (textModelSelect && followModelInput) {
      const syncModel = function () {
        followModelInput.value = textModelSelect.value;
      };
      textModelSelect.addEventListener("change", syncModel);
      syncModel();
    }
